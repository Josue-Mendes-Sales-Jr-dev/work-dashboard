...
export default function Home() {
  return (
   <>
    <Layout>
       <div className="w-[98%] jr:mt-[91.5rem] mj:mt-[80rem] mt-[93rem]  sm:mt-0 h-[85vh] flex flex-col sm:grid  lg:grid-cols-4 lg:grid-rows-4 md:grid-cols-3  items-center justify-center gap-4">
